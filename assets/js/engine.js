...
window.NS_ENGINE = (function (D) {
  ...
  const AI_SPEC = {
    ...
    litres: 'Это книга (тебе дают название, концепцию, текст или аннотацию). Верни 4 группы: ' +
      ...
      '"Аннотации — 5 версий" — ровно 5 разных готовых вариантов аннотации, каждый ОБЪЁМОМ 900–1000 ЗНАКОВ С ПРОБЕЛАМИ (это жёсткое требование: НЕ МЕНЬШЕ 900 знаков). ' +
      'Если черновик получился короче — расширь его: добавь деталей о содержании, пользе для читателя, атмосфере и примерах, пока не наберёшь 900–1000 знаков. Мысленно посчитай длину каждой версии перед ответом. ' +
      'Каждая аннотация — под поиск ЛитРес и естественно насыщена ключевыми словами по теме книги. ' +
